    ...
    <footer className="relative bg-[#0c0e16] border-t border-[rgba(251,250,245,0.1)] pt-16 pb-8 overflow-hidden">
      <div className="px-5 md:px-10 max-w-[1400px] mx-auto">
        <div className="grid md:grid-cols-4 gap-10 mb-16">
          <div>
            <div className="font-mono2 text-[10px] tracking-[0.2em] text-[#ff3b30] mb-3">SITE</div>
          ...
          <div>
            <div className="font-mono2 text-[10px] tracking-[0.2em] text-[#ff3b30] mb-3">DATA</div>
          ...
          <div>
            <div className="font-mono2 text-[10px] tracking-[0.2em] text-[#ff3b30] mb-3">LAND</div>
            <p className="text-sm text-[#fbfaf5]/55 leading-relaxed">
          ...
          <div>
            <div className="font-mono2 text-[10px] tracking-[0.2em] text-[#ff3b30] mb-3">SOURCE</div>
            <p className="text-sm text-[#fbfaf5]/55 leading-relaxed">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="font-mono2 text-[11px] tracking-[0.14em] text-[#ff3b30] inline-block mt-3 hover:text-[#4fc3f7] transition-colors"
            >
              GITHUB ↗
            </a>
          </div>
