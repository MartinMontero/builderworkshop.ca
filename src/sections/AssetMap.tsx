    ...
    <section id="map" className="relative bg-[#12141f] py-20 md:py-28">
      <div className="px-5 md:px-10 max-w-[1400px] mx-auto">
        <div className="flex flex-wrap items-end justify-between gap-6 mb-10 reveal">
          <div>
            <div className="font-mono2 text-[11px] tracking-[0.22em] text-[#ff8f0c] mb-4">01 / THE ASSET MAP</div>
          ...
          <p className="max-w-sm text-sm leading-relaxed text-[#fbfaf5]/60">
            Fourteen physical venues pinned across the Lower Mainland — powered by OpenStreetMap.
                  ...
                  <Popup>
                    <div>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="font-mono2 text-[10.5px] tracking-[0.14em] text-[#ff8f0c] inline-block mt-3 hover:text-[#f6c944]"
                      >
                        VISIT SITE ↗
                      </a>
                    </div>
