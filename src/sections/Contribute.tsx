  ...
  return (
    <section className="noise relative bg-[#12141f] py-20 md:py-28 border-t border-[rgba(251,250,245,0.1)] overflow-hidden">
      ...
      <div className="relative px-5 md:px-10 max-w-[1400px] mx-auto text-center">
        <div className="font-mono2 text-[11px] tracking-[0.22em] text-[#4fc3f7] mb-6 reveal">04 / CONTRIBUTE</div>
        <h2 className="font-display uppercase text-[10vw] md:text-[5.5vw] leading-[0.95] reveal">
          This map is a<br />
          <span className="text-[#ff3b30]">living document.</span>
        </h2>
        ...
        <div className="mt-10 reveal">
          <a
            ...
            className="inline-block font-mono2 text-[11px] tracking-[0.2em] bg-[#fbfaf5] text-[#12141f] px-8 py-4 hover:bg-[#ff3b30] hover:text-[#fbfaf5] transition-colors"
          >
            SUBMIT A PLAYER ↗
          </a>
        </div>
