  ...
  return (
    <section className="noise relative bg-[var(--bg-raise)] py-20 md:py-28 border-t border-[var(--line)] overflow-hidden">
      ...
      <div className="relative px-5 md:px-10 max-w-[1400px] mx-auto text-center">
        <div className="font-mono2 text-[11px] tracking-[0.22em] text-[var(--forest)] mb-6 reveal">05 / CONTRIBUTE</div>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4 reveal">
          <a
            ...
            className="inline-block font-mono2 text-[11px] tracking-[0.2em] bg-[var(--ink)] text-[var(--bg)] px-8 py-4 hover:bg-[#d52b1e] hover:text-[var(--ink)] transition-colors"
          >
            SUBMIT A PLAYER ↗
          </a>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-block font-mono2 text-[11px] tracking-[0.2em] border border-[var(--forest)] text-[var(--forest)] px-8 py-4 hover:bg-[var(--forest)] hover:text-[var(--bg)] transition-colors"
          >
            TAKE THE DATA ↓
          </a>
        </div>
