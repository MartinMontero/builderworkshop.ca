    ...
    <header className={`site-nav fixed top-0 left-0 right-0 z-[1000] ${hidden ? 'nav-hidden' : ''}`}>
      ...
      >
        <a href="#top" className="flex items-center gap-3 group">
          <span className="block w-2.5 h-2.5 bg-[#ff8f0c] group-hover:rotate-45 transition-transform duration-300" />
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="font-mono2 text-[11px] tracking-[0.18em] bg-[#fbfaf5] text-[#12141f] px-4 py-2 hover:bg-[#ff8f0c] transition-colors"
          >
            ADD A PLAYER ↗
          </a>
        </nav>
